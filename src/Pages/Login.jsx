    ...
    <div>
      ...
      <div className='w-full md:w-[1540px] mx-auto mt-[80px] md:mt-[122px] px-4 md:px-0 justify-between'>
                <div className='flex flex-col w-[500px] mx-auto'>
                    <h1 className='w-full text-[96.25rem] text-[#565656] font-bold text-center'>Hello <span className='text-teal-500 font-nunito tracking-[0.02em] leading-[70.75px]'>Again</span></h1>
